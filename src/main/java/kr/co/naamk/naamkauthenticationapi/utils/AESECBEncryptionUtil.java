...
@Component
@NoArgsConstructor
public class AESECBEncryptionUtil {

    private SecretKeySpec secretKey;
    private byte[] key;

    @Value("${secure.aes.ecb.salt}")
    private String SALT;
    @Value("${secure.aes.ecb.secretKey}")
    ...
    public String encrypt(String strToEncrypt) {
        try {
            ...
            return Base64.getEncoder().encodeToString(cipher.doFinal(strToEncrypt.getBytes("UTF-8"))).trim();
        } catch (Exception e) {
